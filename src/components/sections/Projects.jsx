          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
              ...
              <p className="text-gray-400 mb-4">
                <ul className="list-disc list-inside text-gray-300 space-y-2">
                  <li>
                    Product Showcase: High-quality images and detailed
                    descriptions for each product, allowing customers to make
                    informed choices.
                  </li>

                  <li>
                    User-Friendly Checkout: Streamlined checkout process with
                    secure payment integration, ensuring a hassle-free purchase
                    experience.
                  </li>

                  <li>
                    {" "}
                    Responsive Design: Optimized for all devices, providing a
            ...
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
              ...
              <p className="text-gray-400 mb-4">
                <ul className="list-disc list-inside text-gray-300 space-y-2">
                  <li>
                    Designed and developed Tech Care, a web-based platform for
                    managing patient information and medical records.
                  </li>

                  <li>
                    Displays patient details, diagnosis history, blood pressure
                    records, and lab results
                  </li>

                  <li>
                    {" "}
                    Fetches real-time data through API integration for accurate
                    and up-to-date records
                  </li>
                </ul>
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
                {["React", "API", "Chart.js", "ReCharts"].map((tech, key) => (
                  <span
                    key={key}
                    className="bg-blue-500/10 text-blue-500 py-1 px-3 rounded-full text-sm hover:bg-blue-500/20 
                                    hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all
              ...
              <div className="flex justify-between items-center">
                <a
                  href="https://tech-care-red.vercel.app/"
                  target="_blank"
                  className="text-blue-400 hover:text-blue-300 transition-colors my-4"
                >
                  View Project →
            ...
            >
              ...
              <p className="text-gray-400 mb-4">
                <ul className="list-disc list-inside text-gray-300 space-y-2">
                  <li>
                    Designed and developed Midestic Data, a sleek and
                    informative landing page for a data management platform.
                  </li>

                  <li>
                    Showcases key features and benefits of the data solution
                  </li>
